...
unzip SleepEEG.zip -d src/tfc/data/SleepEEG/
unzip  Epilepsy.zip -d src/tfc/data/Epilepsy/
unzip  FD-A.zip -d src/tfc/data/FD_A/
unzip  FD-B.zip -d src/tfc/data/FD_B/
unzip  HAR.zip -d src/tfc/data/HAR/
unzip  Gesture.zip -d src/tfc/data/Gesture/
unzip  ECG.zip -d src/tfc/data/ECG/
unzip  EMG.zip -d src/tfc/data/EMG/
